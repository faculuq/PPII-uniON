Imports uniON.AD
Public Class frmEstadosCategorias
...
#Region "Formulario"
    Private Sub frmEstadosCategorias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "Procedimientos"
    ...
    Private Sub BuscarTodos()
        ...
        Dim oEstadoCategoria As New cEstadosCategorias

        oDs = oEstadoCategoria.BuscarTodos
    ...
    Private Sub BuscarPorID(ByVal ID As Integer)
        ...
        oDs = oEstadoCategoria.BuscarPorId(ID)

        txtID.Text = oDs.Tables(0).Rows(0).Item("IdCategoria")
        ...
        Try
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oEstadoCategoria.Modificar(txtID.Text, txtDescripcion.Text, chkActivo.Checked)
                    MsgBox("Se modificó correctamente la categoría con el código nro: " + txtID.Text, MsgBoxStyle.Information, "Exitos!")
                End If

                If Me.Estado = EstadodelFormulario.eAgregar Then
                    Dim resultado As Integer
                    resultado = oEstadoCategoria.Agregar(txtDescripcion.Text, chkActivo.Checked)
                    MsgBox("Se agregó correctamente la categoría " + txtDescripcion.Text + " con el código nro: " + resultado.ToString, MsgBoxStyle.Information, "Exitos!")
                End If
...
#Region "Funciones"
    Private Function Validar() As Boolean
        If txtDescripcion.Text = "" Then
            ...
            MsgBox("Complete el nombre de la categoría", MsgBoxStyle.Exclamation, "Mensaje")
