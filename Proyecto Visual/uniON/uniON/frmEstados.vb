        ...
        Try
            If Validar() = True Then
                ...
                If Me.Estado = EstadodelFormulario.eEditar Then
                    oProvincia.Modificar(txtId.Text, cboCategoria.SelectedValue, txtEstado.Text, chkActivo.Checked)
                ...
                If Me.Estado = EstadodelFormulario.eAgregar Then
                    ...
                    resultado = oProvincia.Agregar(cboCategoria.SelectedValue, txtEstado.Text, chkActivo.Checked)
