...
<body>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col col-md-6">
                                                        ...
                                                        <div alt="Cargando Imagen..."
                                                            style="background-image:url('Imagenes/subir.png');background-size: cover;height:50px;width:50px;cursor:pointer;decoration:none;"
                                                            required="" name="imagen" id="files" type="file"
                                                            accept="image/*">
                                                            <center>
                                                                <asp:FileUpload
                                                                    style="background-image:url('Imagenes/ErrorTickets.png');background-size: cover; opacity: 0; height:80px;width:80px;cursor:pointer;margin-top:-5px;decoration:none;"
                                                                    runat="server" id="btnSubirImg"
                                                                    onchange="readURL(this);" runat="server">
                                                                </asp:FileUpload>
                                                            </center>
                                                        </div>
                                                    </div>
    ...
    box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.2); object-fit:cover;" />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col col-md-6 contBtn">
                                                        <br />
                    ...
                    ACEPTAR</button>--%>
                                                     ...
                                                     <asp:Button runat="server" id="BtnAceptar"
                                                            class="boton" style=" width:100%; min-width:220px; color:White; background:#72C05B ; border: 1px solid #72C05B ; border-radius: 2em; padding: 6px 18px;"
