<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmInicioEmpresa.aspx.vb" Inherits="uniON.WEB.frmInicioEmpresa" %>
            ...
            <nav class="navbar navbar-expand-sm navbar-right" role="navigation">
                <div class="main-menu">
                    <ul id="nav" class="nav navbar-nav">
                       ...
                       <li style="margin-left:10px" class="drop"><a href="frmModificarDatosEmpresa.aspx" class="nav-link">Mi Info</a></li>
                       ...
                       <li style="margin-left:10px" class="drop"><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Premios</a>
                            <div class="dropdown-menu">
                                ...
                                <a href="frmCargaPremios.aspx" class="dropdown-item">Nuevo Premio</a>
                            </div>
                        </li>
                    </ul>
                </div>
