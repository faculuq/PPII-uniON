...
<body>
    ...
    <form class="form-signup" runat="server" method="post" name="form">
      ...
      <div>
        ...
        <h1 class="welcome">Bienvenido, Chris</h1>
        <a class="btn-goback" value="Refresh" onClick="history.go()">Volver atrás</a>
      </div>
    </div>
